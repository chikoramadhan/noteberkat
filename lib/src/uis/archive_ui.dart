...
class _State extends State<ArchiveUI> with AfterLayoutMixin {
  ...
  void initState() {
    super.initState();
    archiveProvider = Provider.of<ArchiveProvider>(context, listen: false);
  ...
  void afterFirstLayout(BuildContext context) {
    _scrollController.addListener(() {
      if (_scrollController.position.atEdge && _scrollController.offset > 0) {
        Provider.of<ArchiveProvider>(context, listen: false).scrollData(
            param: archiveProvider.selectedFilter != null
                ? archiveProvider.selectedFilter!.data
                : _param(_data));
      }
    });
    ...
    archiveProvider.loadAllData(context: context);
  }
        ...
        Consumer<ArchiveProvider>(
          builder: (context, value, child) {
            return Scaffold(
              ...
              body: _body(),
              floatingActionButton: archiveProvider.selectedFilter != null
                  ? FloatingActionButton(
                      onPressed: () {
                        archiveProvider.selectedFilter = null;
                        archiveProvider.data!.clear();
                        archiveProvider.newData(param: _param(_data));
                      },
                      backgroundColor: Colors.white,
                      child: Icon(
                        Icons.close,
              ...
              showDialog(
                  ...
                  builder: (context) => CupertinoAlertDialog(
                        ...
                        content: Padding(
                          ...
                          child: new Text(
                              'Are you sure want to restore ${_listRestore.length} selected chat?'),
                        ),
                        actions: <Widget>[
  ...
  SliverList _buildList(ArchiveProvider archive) {
    double _radius = 15;
    ...
    return SliverList(
      delegate: SliverChildBuilderDelegate(
              ...
              return StatefulBuilder(
                builder: (context, setState) {
                  return Card(
                    ...
                    child: Container(
                      ...
                      child: Material(
                        ...
                        child: InkWell(
                          ...
                          onLongPress: () {
                            if (isAdmin(user)) {
                              this.setState(() {
                                _listRestore.add(archive.data![index]);
                                _restoreMode = true;
                              });
                            }
                          },
                          onTap: () {
                            if (!_restoreMode) {
                              archive.chat = archive.data!.elementAt(index);
                              Navigator.of(context).pushNamed(kRouteNoteAdd);
                            } else {
                              setState(() {
                                if (_listRestore.firstWhere(
                                        (element) =>
                                            element == archive.data![index],
                                        orElse: () => null) !=
                                    null) {
                                  _listRestore.remove(archive.data![index]);
                                } else {
                                  _listRestore.add(archive.data![index]);
                                }
                              });
                                  ...
                                  children: [
                                    Column(
                                      ...
                                      children: [
                                        ...
                                        ..._info(
                                            archive.data!.elementAt(index)!),
                                        SizedBox(
                                          height: 18.0,
                                        ),
                                        Text(
                                          archive.data!.elementAt(index)!.chat!,
                                          style: TextStyle(
                                            color: archive.data!
                                                            .elementAt(index)!
                                                            .updateAgent ==
                                  ...
                                  child: Container(
                                    ...
                                    child: Center(
                                      child: Visibility(
                                        ...
                                        visible: _listRestore.firstWhere(
                                                (element) =>
                                                    element ==
                                                    archive.data![index],
                                                orElse: () => null) !=
                      ...
                      decoration: BoxDecoration(
                        gradient: LinearGradient(
                          colors: [
                            archive.data!.elementAt(index)!.updateAgent ==
                                        null &&
                                    isStaff(user)
                                ? Colors.white
                                : Color(0xff0396ff),
                    ...
                    elevation: 1.0,
                    color:
                        archive.data!.elementAt(index)!.updateAgent == null &&
                                isStaff(user)
                            ? Colors.black
                            : Color(0xffffefefe),
                  );
        ...
        childCount: archive.data == null || archive.data!.length == 0
            ? 1
            : archive.data!.length,
      ),
    );
...
class _ModalBottomSheetState extends State<ModalBottomSheet> {
  ...
  void initState() {
    ...
    setCategory(archiveProvider);
    setDisplay(_itemSelected, archiveProvider);
    setBuildingType(archiveProvider);
  ...
  setCategory(ArchiveProvider value) {
    categoryDisplayFull = [];
    categoryDisplay = [];
  ...
  setBuildingType(ArchiveProvider value) {
    buildingTypeDisplayFull = [];
    buildingTypeDisplay = [];
  ...
  setDisplay(String? item, ArchiveProvider value) {
    if (item == "-") {
      display = null;
      displayFull = null;
    } else if (item == "Area") {
